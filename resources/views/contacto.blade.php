...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <main style="min-height: 35vw;"> 
     <div class="skew-cc-top"></div>
        <div class="section_1">
            <div class="content_1">
                <h1 class="titles">SOMOS CERCANOS</h1>
                <div class="row text_section_1">
                    <div class="col-12" ><h5  >En Where Is, creemos en la importancia del significado cliente satisfecho, y eso nos hace líderes en el sector.</h5></div>
                </div>
            </div>
        </div>
        ...
        <div class="section_2 bg-dark text-light" >
            <div class="content_2">
                <h3 class="titles" >Datos de contacto</h3>
                <div class="row text_section_2">
                    <div class="col-4">
                        <dl class="s2_llista">
                            <dt><i class="fa-solid fa-house-chimney"></i> Calle Jalance 12 46022, Valencia, España</dt>
                            <dt><i class="fa-solid fa-phone"></i> +34 963811782</dt>
                            <dt><i class="fa-solid fa-envelope"></i> whereis@empresa.es</dt>
                            <dt><i class="fa-solid fa-globe"></i> Where Is</dt>
